"""Compute and plot per-used-GPU Step4-Pro-V1/DeepSeek throughput ratios."""
...
from tests.performance.aic_roofline_pareto.run_dsv4pro_vs_step4pro_throughput import ISL_VALUES

MODEL_STEP4PRO = "stepfun-ai/Step4-Pro-V1"
MODEL_DEEPSEEK = "deepseek-ai/DeepSeek-V4-Pro"
BASELINE_LABEL = "Step4-Pro-V1 baseline"
RATIO_DIRECTION = "Step4-Pro-V1 / DeepSeek-V4-Pro"
    ...
    *,
    ...
    for (display_system, _system, isl), model_rows in grouped.items():
        ...
        for figure, field in fields.items():
            numerator = _finite_positive(step4pro.get(field), field=f"Step4-Pro-V1 {field}")
...
def _plot_one(
    ...
    *,
    ...
    axis.set_ylabel("Per-used-GPU throughput ratio (Step4-Pro-V1 / DeepSeek-V4-Pro)")
...
def generate_figures(
    ...
    *,
    ...
    _plot_one(
        ratios["prefill"],
        systems=systems,
        title="Prefill per-used-GPU throughput ratio (Step4-Pro-V1 / DeepSeek-V4-Pro)",
        output_path=figure_paths["prefill"],
    )
    _plot_one(
        ratios["decode"],
        systems=systems,
        title="Decode per-used-GPU throughput ratio (Step4-Pro-V1 / DeepSeek-V4-Pro)",
